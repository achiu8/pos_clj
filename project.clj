(defproject pos_clj "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "pos-clj.core/on-figwheel-reload"}

                :compiler {:main pos-clj.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/pos_clj.js"
